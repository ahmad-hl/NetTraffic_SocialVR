...
in_dir_names = ['results/synth6','results/synth6.2']
oculus_dir_name = 'results/synth6Oculus'
...
ax1.set_title('VH1 for 2 users', font_dict, loc='right', pad=1, y= 0.95)
...
ax2.set_title('VH1 for 4 users', font_dict,  loc='right', pad=1, y= 1)
# We change the fontsize of minor ticks label
...
ax3.set_title('VH1 for 8 users', font_dict,  loc='right', pad=1, y= 0.95)
# We change the fontsize of minor ticks label
...
ax4.set_title('VH1 for 16 users', font_dict,  loc='right', pad=1, y= 0.95 )
# We change the fontsize of minor ticks label
