...
def launchTabs(link):
    ...
    button_sequence = ["Join Room","Accept", "Enter Room"]  # "Join Room",
    driver.get(link)
...
if __name__ == '__main__':
    tabs = 8
    # new_room_uri =  'https://hub.metaust.link/eJ9JEUa/'
    # new_room_uri = 'https://hub.metaust.link/scenes/4cqmZ3Q'
    new_room_uri = 'https://hub.metaust.link/8kes5wp'
    #download json file on exit
    dir_name = '../results_conf/synth19'
