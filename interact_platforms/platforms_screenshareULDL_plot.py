...
spatial_dir_name = 'results_platforms/solid_uldl'
hubs_dir_name = 'results_platforms/solid_uldl'
parentDir = os.path.dirname(os.path.realpath(__file__))
ULDL_spatial_PATH = os.path.join(parentDir, '..',spatial_dir_name, 'spatial.uldl_scrnshare.log')
ULDL_hubs_PATH = os.path.join(parentDir, '..',hubs_dir_name, 'hubs.uldl_scrnshare.log')
...
Fig_PATH = os.path.join(parentDir, 'figures', 'uldl_platforms.pdf')
